class ManageHouseholdsPage
  ...
  checkbox(:auto_formal_greeting, id:'hhAutoFormalGreeting')
  checkbox(:auto_informal_greeting, id: 'hhAutoInformalGreeting')
  checkbox(:auto_name, id: 'hhAutoName')
  ...
  checkbox(:exclude_formal_greeting_second, class: 'hh-formal-exclude-input', index: 1)
  checkbox(:exclude_informal_greeting_original, class: 'hh-informal-exclude-input', index: 0)
  checkbox(:exclude_informal_greeting_second, class: 'hh-informal-exclude-input', index: 1)
  checkbox(:exclude_household_name_original, class: 'hh-name-exclude-input', index: 0)
  checkbox(:exclude_household_name_second, class: 'hh-name-exclude-input', index: 1)
  a(:first_household_link, text: /Household/)
